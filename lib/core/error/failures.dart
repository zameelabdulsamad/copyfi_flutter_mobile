...
class PaymentFailure extends Failure {
  ...
  PaymentFailure({String? message = kMessagePaymentFailure, this.paymentInfo})
      : super(message, "PaymentFailure");
}

///Looks like we couldn't connect to the Genskill network. Please check whether your connection is fine and try again.
const kMessageNetworkDown =
    "Looks like we couldn't connect to the Genskill network. Please check whether your connection is fine and try again.";

///We're trying to connect to the genskill network but it looks like it's taking longer than usual. Please check whether your connection is fine and try again.
const kMessageConnectionTimeout =
    "Looks like we couldn't connect to the Genskill network within time. Please check whether your connection is fine and try again.";
